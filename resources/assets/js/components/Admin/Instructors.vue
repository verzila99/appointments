    ...
    <div class = "container  pt-16 h-screen flex flex-col items-end gap-6">
                ...
                >
                    ...
                    <vs-td>
                        <div
                            ...
                            @click = "edit($event) "
                            class = "btn bg-primary text-blue-50 ">Edit
                        </div>
                    </vs-td>
                    <vs-td>
                        <div
        ...
        <div class = "flex justify-between items-center gap-4">
            <div
                ...
                @click = "addActive=true">Add instructor
            </div>
        </div>
        <vs-dialog v-model = "editActive">
            ...
            <div class = "flex justify-between items-start gap-6">
                ...
                <div class = "flex  flex-wrap justify-center items-center gap-6">
                    <vs-input @keypress.enter = "saveInstructor"
            ...
            <a href = ""
               ...
               @click.prevent = "saveInstructor">Save</a>
        </vs-dialog>
        <vs-dialog v-model = "addActive">
            ...
            <div class = "flex justify-between items-start gap-6">
                <div class = "flex  flex-wrap justify-center items-center gap-6">
                    <vs-input @keypress.enter = "addInstructor"
            ...
            <a href = ""
               class = "btn bg-primary text-blue-50 my-6"
               @click.prevent = "addInstructor">Add</a>
        </vs-dialog>
...
export default {
    ...
    methods: {
        edit(event) {
            ...
            this.editingInstructor.working_days = event.target.dataset.working_days;
        ...
        saveInstructor() {
            ...
            axios.get('/sanctum/csrf-cookie').then(() => {
                axios.put('/api/instructors/' + this.editingInstructor.id, {
                    ...
                    loading.close();
                    this.openNotification('success', 'Instructor updated.', 'top-right');
                }).catch(error => {
                    loading.close();
        ...
        deleteInstructor() {
            ...
            axios.get('/sanctum/csrf-cookie').then(() => {
                axios.delete('/api/instructors/' + this.deletingId).then((response) => {
                    if (response.status === 200) {
                        console.log(response);
                        this.instructors = this.instructors.filter(item => +item.id !== +this.deletingId);
                        this.openNotification('success', 'Instructor deleted.', 'top-right');
                    }
