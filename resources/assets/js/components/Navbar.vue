<template>
    <div>
        <div
            class="container shadow-sm flex justify-around align items-center h-20 bg-white"
        >
            <router-link to="/" class="logo text-6xl text-gray-600"
            ...
            <div class="navbar-right flex justify-around items-center ">
                ...
                >
                    <div class="flex justify-around items-center gap-4">
                        ...
                        <a class="a-icon capitalize cursor-pointer">
                            {{ nickname }}</a
                        >
                        <a
                            v-if="role && role > 0"
